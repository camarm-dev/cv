...
export const RESUME_DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Grâce à mon auto-entreprise Labse Studio, j'aide les projets indépendants (projets open source, associations...) dans leur présence en ligne et leur processus de travail.",
    },
    {
      company: "Mmicro",
